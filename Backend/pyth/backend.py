"""
DEPRECATED: This Flask backend has been replaced with a Node.js backend.

The posture detection functionality has been moved to a separate microservice.
Please use the new Node.js backend (server.js) and posture detection service (posture_detector.py).

To run the new system:
1. Start the Node.js backend: node server.js (port 3000)
2. Start the posture detection service: python posture_detector.py (port 5001)
3. Start the frontend: npm run dev (port 5173)

This file is kept for reference only.
"""

print("⚠️  This Flask backend is deprecated!")
print("Please use the new Node.js backend instead:")
print("1. cd Backend && node server.js")
print("2. cd Backend && python posture_detector.py") 
print("3. cd Frontend && npm run dev")

import os

# Legacy code maintained for reference only...
